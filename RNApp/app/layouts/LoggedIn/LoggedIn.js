...
class LoggedIn extends React.Component {
  ...
  render() {
    return (
      <TabNavigator>
        {this.renderTabItem('Globe', Routes.getMapViewRoute("THE WORLD"), images.icons.globe)}
        {this.renderTabItem('Map', Routes.getMapViewRoute("UNITED STATES"), images.icons.geolocation)}
